...
//inicio do desafio(variaveis)
 int main(){
    ...
    superpoder1 = (1/densidade_populacional1) + população1 + area1 + pib1 + pontos_turisticos1 + pib_porcapita1;
    ...
    superpoder2 = (1/densidade_populacional2) + população2 + area2 + pib2 + pontos_turisticos2 + pib_porcapita2;
    ...
    printf("pib por capita: %.2f\n", pib_porcapita2);
    printf("superpoder 2: %.2f\n", superpoder2);

    // comparação das cartas

    printf("\ncomparação\n");
    printf("carta %d ganha\n", (população1 > população2) ? 1:2);
    printf("carta %d ganha\n", (area1 > area2) ? 1:2);
    printf("carta %d ganha\n", (pib1 > pib2) ? 1:2);
    printf("carta %d ganha\n", (pontos_turisticos1 > pontos_turisticos2) ? 1:2);
    printf("carta %d ganha\n", (densidade_populacional1 < densidade_populacional2) ? 1:2); // esse aqui tem valor invertido
    printf("carta %d ganha\n", (pib_porcapita1 > pib_porcapita2) ? 1:2);
